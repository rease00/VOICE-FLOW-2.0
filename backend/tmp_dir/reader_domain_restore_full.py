...
READER_BILLING_VF_PER_CHAR = 1.5
...
READER_FALLBACK_CATALOG: tuple[dict[str, Any], ...] = (
    {
        ...
        "sampleText": (
            ...
            "This VoiceFlow seed includes a short public-domain sample so the Reader can start without waiting for a full-source fetch."
        ),
    },
    {
